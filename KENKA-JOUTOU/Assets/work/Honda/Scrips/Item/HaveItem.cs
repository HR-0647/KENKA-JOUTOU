...
public class HaveItem : MonoBehaviour
{
    ...
    private void OnTriggerStay(Collider other)
    {
        if (other.gameObject.CompareTag("item"))
        {
            ...
            {
                GameObject InGrab = Instantiate(Resources.Load("Prehabs/HaveItem"),Grab1.transform.position,Grab1.transform.rotation) as GameObject;
            ...
            {
                GameObject InGrab2 = Instantiate(Resources.Load("Prehabs/HaveItem"),Grab2.transform.position, Grab2.transform.rotation) as GameObject;
